...
This MY_Model based on **Jamie Rumbelow's Base Model** (https://github.com/jamierumbelow/codeigniter-base-model), but with some changed/added methods. I add function seach and will add new function to make more easy to get data from database with codeigniter.
...
$this->user_model->get_search('keyword','field','0','10','DESC');
```
